...
- [Индивидуальный проект | Информационный портал о кандидатах и их программе](#project)
- [Контакты](#contacts)
...
## <a id="project">Индивидуальный проект | Информационный портал о кандидатах и их программе</a>

### [Решение](https://github.com/I-am-DaKoTa/Informational-Portal/tree/main)
